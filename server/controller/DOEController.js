...
module.exports.createDOE=async (req, res,next) => {
    try {
        const { email, Name, mobile, university, aadhar, city, pincode, address, state, dob, department} = req.body;
        ...
        const newUser = new DOE({
            email, Name, mobile, university, aadhar, city, pincode, address, state, dob,username,password,department,passportPhoto:passportPhotoPath
        })
        await newUser.save();
